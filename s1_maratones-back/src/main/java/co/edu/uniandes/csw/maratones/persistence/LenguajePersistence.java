...
public class LenguajePersistence {
     ...
     *
     * @param lenguajeEntity: el lenguaje que viene con los nuevos cambios. Por ejemplo
     * el nombre pudo cambiar. En ese caso, se haria uso del método update.
     * @return un ejercicio con los cambios aplicados.
     */
    public LenguajeEntity update(LenguajeEntity lenguajeEntity) {
        LOGGER.log(Level.INFO, "Actualizando el lenguaje con id={0}", lenguajeEntity.getId());
        return em.merge(lenguajeEntity);
    }
