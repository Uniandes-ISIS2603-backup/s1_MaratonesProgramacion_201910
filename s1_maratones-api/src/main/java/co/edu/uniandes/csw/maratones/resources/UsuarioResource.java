...
public class UsuarioResource {
    ...
    public UsuarioDetailDTO getUsuario(@PathParam("nombreUsuario") Long elNombreUsuario) {
        ...
        UsuarioEntity usuarioEntity = elNombreUsuario.getUsuario(elNombreUsuario);
        ...
        LOGGER.log(Level.INFO, "UserResource getUsuario: output: {0}", detailDTO);
        return detailDTO;
    }
    ...
    public UsuarioDetailDTO updateUsuario(@PathParam("nombreUsuario") Long elNombreUsuario, UsuarioDetailDTO elUsuario) {
        LOGGER.log(Level.INFO, "UserResource updateUsuario: input: elNombreUsuario: {0} , usuario: {1}", new Object[]{elNombreUsuario, elUsuario});
                elUsuario.setNombreUsuario(elNombreUsuario);
        if (elUsuariolLogic.getUsuario(elNombreUsuario) == null) {
            throw new WebApplicationException("El recurso /usuarios/" + elNombreUsuario + " no existe.", 404);
        }
        UsuarioDetailDTO detailDTO = new UsuarioDetailDTO(elUsuariolLogic.updateUsuario(elNombreUsuario, elUsuario.toEntity()));
